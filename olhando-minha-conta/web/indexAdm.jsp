            ...
            <div class="content mx-1">
                ...
                <main class="w-100 d-flex justify-content-center align-items-center flex-column">
                    <nav class="flex-column d-flex">
                        <a href="usuarioController?acao=mostrar"><button class="btn btn-primary w-100 m-2">Usuários</button></a>
                        <a href="administradorController?acao=mostrar"><button class="btn btn-primary w-100 m-2">Administradores</button></a>
                        <a href="categoriaController?acao=mostrar"><button class="btn btn-primary w-100 m-2">Categorias</button></a>
                    </nav>
